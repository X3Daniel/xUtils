package com.lidroid.xutils.http.download;
...
public class DownloadManager {
    ...
    public static final int STATUE_CODE_START = 100;
    public static final int STATUE_CODE_LOADING = 102;
    public static final int STATUE_CODE_STOPED = 101;
    public static final int STATUE_CODE_SUCCESS = 200;
    public static final int STATUE_CODE_COMP = 416;
    ...
    public int indexOfDownloadInfo(DownloadInfo downloadInfo ){
        return downloadInfoList.indexOf(downloadInfo);
    }

    public boolean addNewDownload(String url, String fileName, String target,
                               boolean autoResume, boolean autoRename,
                               final RequestCallBack<File> callback) throws DbException {
        for (DownloadInfo downloadInfo : downloadInfoList) {
            if (target.equals(downloadInfo.getFileSavePath())){
                return false;
            }
        }
    ...
    public class ManagerCallBack extends RequestCallBack<File> {
        ...
        public void onStart() {
            ...
            try {
                downloadInfo.setStatueCode(STATUE_CODE_START);
                db.saveOrUpdate(downloadInfo);
            } catch (DbException e) {
                LogUtils.e(e.getMessage(), e);
            }
        ...
        public void onStopped() {
            ...
            try {
                downloadInfo.setStatueCode(STATUE_CODE_STOPED);
                db.saveOrUpdate(downloadInfo);
            } catch (DbException e) {
                LogUtils.e(e.getMessage(), e);
            }
        ...
        public void onLoading(long total, long current, boolean isUploading) {
            ...
            downloadInfo.setDownSpeed(current - downloadInfo.getProgress());
            downloadInfo.setProgress(current);
            try {
                downloadInfo.setStatueCode(STATUE_CODE_LOADING);
                db.saveOrUpdate(downloadInfo);
            } catch (DbException e) {
                LogUtils.e(e.getMessage(), e);
            }
        ...
        public void onSuccess(ResponseInfo<File> responseInfo) {
            ...
            try {
                downloadInfo.setStatueCode(STATUE_CODE_SUCCESS);
                db.saveOrUpdate(downloadInfo);
            } catch (DbException e) {
                LogUtils.e(e.getMessage(), e);
            }
        ...
        public void onFailure(HttpException error, String msg) {
            ...
            try {
                downloadInfo.setStatueCode(error.getExceptionCode());
                db.saveOrUpdate(downloadInfo);
            } catch (DbException e) {
                LogUtils.e(e.getMessage(), e);
            }
