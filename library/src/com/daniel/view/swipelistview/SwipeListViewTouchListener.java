...
package com.daniel.view.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    private HashSet<Integer> disablePos = new HashSet<Integer>();
...
//                }
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if(disablePos!=null && disablePos.contains(downPosition)){
                   return false;
                }
                velocityTracker.addMovement(motionEvent);
                velocityTracker.computeCurrentVelocity(1000);
    ...
    public HashSet<Integer> getDisablePos() {
        return disablePos;
    }

    public void setDisablePos(HashSet<Integer> disablePos) {
