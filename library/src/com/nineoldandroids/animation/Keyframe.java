 ...
 * of {@link com.nineoldandroids.animation.TypeEvaluator}), you should stick to using float and int as animations using those
...
public abstract class Keyframe implements Cloneable {
     ...
     * {@link com.nineoldandroids.animation.TypeEvaluator} to use when calculating values between keyframes. The type is based
